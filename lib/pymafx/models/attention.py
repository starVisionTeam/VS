...
from .transformers.bert.modeling_bert import BertPreTrainedModel, BertEmbeddings, BertPooler, BertIntermediate, \
...
def get_att_block(
    ...
    config = config_class.from_pretrained('../lib/pymafx/models/transformers/bert/bert-base-uncased/config.json')
