...
class MeshEvaluator:
    ...
    def _render_normal(self, mesh, deg):
        ...
        self._normal_render.set_normal_mesh(self.scale_factor * mesh.vertices, mesh.faces, mesh.vertex_normals,
                                            mesh.faces)
    ...
    def run(root, exp_name, tar_path):
        ...
        for file in buff_files:
            ...
            for src in src_names:
                ...
                vals.append(4.0 * evaluator.get_reproj_normal_error(
                    save_demo_img=os.path.join(src_path, '%s_%s.png' % (name, src[:-4]))))
